...
monomer_mnx_dic = get_nrps_monomers('Input_monomers_nrps.txt')

# extracting information of total combined (V)
#second_total_monomers = extract_second_metab_monomers(inputfile, "genbank", monomer_mnx_dic)
...
dic_info_of_bundle_set_met = extract_sub_set_met_info_from_genebank(inputfile, "genbank", dic_nrps_gene)
