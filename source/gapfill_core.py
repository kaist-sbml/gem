...
class gapfilling_precursor():
    ...
    def change_reversibility(self,target_reaction, cobra_model):
        ...
        print status
        print ObjVal
        print "Reaction with reversibility to be modified:", rev_changed_reaction
    ...
    def run_GapFill(self, target_reaction, flux_constraints={}, UniversalReactions=[]):
        ...
        #Check tolerance: too small number may cause infeasibility or no solution
        #0.01 produced no solution and values >= 1 produced the same reaction to add
        #addConstr modification : 0.01 -> 1.00
        m.addConstr(v[target_reaction]>= 1)
